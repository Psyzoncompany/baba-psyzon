...
try {
  ...
  console.error(`Baba Psyzon MCP iniciado para ${config.accounts.length} conta(s): ${config.accounts.map(({ alias }) => alias).join(', ')}. Escrita: ${config.writesEnabled ? 'ativada' : 'desativada'}.`);
} catch (error) {
